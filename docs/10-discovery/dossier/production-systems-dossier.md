...
These findings are consistent with — and provide the evidence base for — the dispositions already recorded in `docs/40-planning/CONSOLIDATION.md` and `docs/30-architecture/adr/ADR-001-target-stack.md` of this repository. This dossier records constraints and implications only; it deliberately contains **no target architecture and no migration plan**.
...
This matches the disposition table in `docs/40-planning/CONSOLIDATION.md`; this dossier supplies the underlying evidence.
