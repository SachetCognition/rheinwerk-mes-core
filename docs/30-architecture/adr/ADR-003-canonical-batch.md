...
- **Decision:** One canonical Batch carrying identity + QA state (Quarantined/Released/Blocked workflow) + expiry + genealogy links, deliberately designed beyond all three sources; anchor Batch DocType is the storage base, extended — never forked. Full spec: `docs/30-architecture/canonical-model/README.md` §CDM-01.
