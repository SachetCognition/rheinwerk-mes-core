...
Wave: W0 (Foundation) · Verifies: `docs/20-requirements/foundation/URS-W0-foundation.md` · Status: Draft for review
...
Executable form of the W0 exit criteria (`docs/20-requirements/foundation/URS-W0-foundation.md` §6); this checklist closes the W0 Epic.
