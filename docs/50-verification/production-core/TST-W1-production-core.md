...
Wave: W1 (Production Core) · Verifies: `docs/20-requirements/production-core/URS-W1-production-core.md` · Status: Draft for review
...
Executable form of the W1 exit criteria (`docs/20-requirements/production-core/URS-W1-production-core.md` §6); this checklist closes the W1 Epic.
