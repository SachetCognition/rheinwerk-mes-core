...
**Verifies:** `docs/urs/URS-W2-traceability-quality.md` (URS-W2-001…036)
...
- **Design-conformance** — screen review against `rheinwerk-mes-design-SKILL.md` Definition of done, plus automatable checks (contrast, keyboard path, pill composition, modal refusals).
