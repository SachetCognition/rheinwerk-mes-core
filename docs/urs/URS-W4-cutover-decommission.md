...
**Sources:** `docs/waves/W4-cutover-decommission.md` (W4-1…W4-7) · `CONSOLIDATION.md` · `docs/adr/ADR-003/004/005` · `docs/canonical-model/README.md` (CDM-01, CDM-02, CDM-03) · `docs/dossier/production-systems-dossier.md` §3.1/§3.3, §5.3, §7 (implications 4, 9, 10), §8.2 (#2, #3, #7) · `rheinwerk-mes-design-SKILL.md`
...
Restated from `docs/waves/W4-cutover-decommission.md` ("**Exit:** all personas on target; decommission complete") and decomposed:
