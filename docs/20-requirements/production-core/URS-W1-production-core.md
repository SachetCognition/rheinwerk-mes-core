...
- **Priority:** Must
- **Lineage:** Wave exit criterion · — · `docs/40-planning/production-core/W1-production-core.md` W1-10; ADR-001 consequence; URS-W0-013 evidence-pack generator
- **Acceptance criteria:**
...
Restated from `docs/40-planning/production-core/W1-production-core.md` ("planner + operator journeys pass acceptance; behaviour choices vs characterisation tests documented") and decomposed:
