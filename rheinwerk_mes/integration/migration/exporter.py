"""Re-exporter: target site → canonical format (URS-W0-009).

Identity preservation is only provable if the target is read back the same way for every
...
record that never arrived is simply absent, which shows up as a count mismatch.
"""
