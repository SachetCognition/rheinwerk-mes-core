...
#: Programme role owning the production order (created by the W0 access-control baseline).
APPROVER_ROLE = "Rheinwerk Planner"
...
def custom_field_definitions() -> dict[str, list[dict]]:
	...
	return {
		"Work Order": [
			...
			# The audit table must stay writable once the order is submitted.
			{
