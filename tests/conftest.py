...
# The bare `pytest` entrypoint — unlike `python -m pytest` — does not put the working
# directory on `sys.path`, so `rheinwerk_mes` would not be importable from the suites.
