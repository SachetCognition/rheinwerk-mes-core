...
* **offline** — pure-python logic and repo-structure checks; no site needed.
...
# The bare `pytest` entrypoint — unlike `python -m pytest` — does not add the working
# directory to `sys.path`; without this the `rheinwerk_mes` package would not import.
